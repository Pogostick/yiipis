...
(function($) {
  ...
  Sexy = {
    ...
    messageBox: function(type, message, properties, input) {
        ...
        properties = $.extend({
          'textBoxBtnOk'        : 'Yes',
          'textBoxBtnOkNoMail'  : 'Yes, but no email',
          'textBoxBtnCancel'    : 'No',
        ...
        else if(type == 'confirmCustom')
        {
            $('#'+this.options.name+'-Buttons').append('<input id="BoxConfirmBtnOk" type="submit" /> <input id="BoxConfirmBtnOkNoMail" type="submit" /> <input id="BoxConfirmBtnCancel" type="submit" />');
            $('#BoxConfirmBtnOk').val(properties.textBoxBtnOk).css({'width':70});
            $('#BoxConfirmBtnOkNoMail').val(properties.textBoxBtnOkNoMail).css({'width':70});
            $('#BoxConfirmBtnCancel').val(properties.textBoxBtnCancel).css({'width':70});
            ...
            $('#BoxConfirmBtnOkNoMail').bind('click', $.bind(this, function(){
            ...
            $('#BoxConfirmBtnCancel').bind('click', $.bind(this, function(){
              this.options.onReturn = false;
              this.options.onReturnExtra = false;
              this.display(0);
            }));
    ...
    */
    ...
    /*
    Property: confirmCustom
      Shortcut for confirmCustom

    Argument:
      properties - see Options in messageBox
    */
    confirmCustom: function(message, properties){
      this.messageBox('confirmCustom', message, properties);
    },
